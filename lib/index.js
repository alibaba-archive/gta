...
/***/ function(module, exports, __webpack_require__) {
	...
	Providers = __webpack_require__(7);
	...
	GTA = (function() {
	  ...
	  GTA.prototype.registerProvider = function(name, Provider, $el) {
	    var account, bootParams, randomProportion, scriptUrl, trackUrl;
	    if ($el == null) {
	      $el = document.getElementById('gta-main');
	    }
	    if (!$el) {
	    ...
	    if (account) {
	      this.providers.push(new Provider(account, scriptUrl, trackUrl, bootParams));
	      return true;
	    }
	    return false;
	  };
	  ...
	  GTA.prototype.setUser = function(id, user, turnOff) {
	  ...
	  GTA.prototype.login = function(userId) {
	    var e, i, len, provider, ref, ref1;
	    try {
	      ref = this.providers;
	      for (i = 0, len = ref.length; i < len; i++) {
	        provider = ref[i];
	        if ((ref1 = provider.login) != null) {
	          ref1.apply(provider, arguments);
	        }
	      }
	    } catch (error) {
	  ...
	  GTA.prototype.logout = function() {
	    var e, i, len, provider, ref, ref1;
	    try {
	      ref = this.providers;
	      for (i = 0, len = ref.length; i < len; i++) {
	        provider = ref[i];
	        if ((ref1 = provider.logout) != null) {
	          ref1.apply(provider, arguments);
	        }
	      }
	    } catch (error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DistinctID, Referral, UTM;

	UTM = __webpack_require__(3);

	Referral = __webpack_require__(5);

	DistinctID = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasePlugin, DistinctID,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	BasePlugin = __webpack_require__(4);

	module.exports = DistinctID = (function(superClass) {
	  extend(DistinctID, superClass);

	  DistinctID.prototype.name = 'distinct id synchronizer';

	  function DistinctID(gta) {
	    var e;
	    try {
	      if (window.tbpanel && window.sa) {
	        sa.quick('isReady', function() {
	          return tbpanel.identify(sa.store.getDistinctId());
	        });
	      }
	    } catch (error) {
	      e = error;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Baidu, Customer, Fullstory, Google, GrowingIO, Sensors, TBPanel;

	Google = __webpack_require__(8);

	Baidu = __webpack_require__(10);

	Customer = __webpack_require__(11);

	Fullstory = __webpack_require__(12);

	GrowingIO = __webpack_require__(13);

	TBPanel = __webpack_require__(14);

	Sensors = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	BaseProvider = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = TBPanel = (function(superClass) {
	  ...
	  TBPanel.prototype.loaded = false;

	  TBPanel.prototype.loadHandlers = [];

	  function TBPanel(account, scriptUrl, track, bootParams) {
	    this.handleTBPanelLoaded = bind(this.handleTBPanelLoaded, this);
	    var e, lib_name, options, script, tbpanel;
	    if (!account) {
	      return;
	    }
	    scriptUrl || (scriptUrl = '//g.alicdn.com/teambition-fe/static-files/tbpanel/generic.36b6.js');
	    lib_name = 'tbpanel';
	    if (track) {
	      window.TBPANEL_TRACK_URL = track;
	    }
	    ...
	    tbpanel.__SV = 1.2;
	    options = {
	      loaded: this.handleTBPanelLoaded
	    };
	    try {
	  ...
	  TBPanel.prototype.handleTBPanelLoaded = function() {
	    var handler;
	    this.loaded = true;
	    while (handler = this.loadHandlers.shift()) {
	      handler();
	    }
	  };

	  TBPanel.prototype.onLoad = function(handler) {
	    if (this.loaded) {
	      handler();
	    } else {
	  ...
	  TBPanel.prototype.login = function(userId) {
	    return this.onLoad(function() {
	      var distinctid, host, ref, ref1, req;
	      host = (ref = window.tbpanel) != null ? ref.get_config('api_host') : void 0;
	      distinctid = (ref1 = window.tbpanel) != null ? ref1.get_distinct_id() : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseProvider, Common, SensorsData,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	module.exports = SensorsData = (function(superClass) {
	  extend(SensorsData, superClass);

	  SensorsData.prototype.name = 'sensorsdata';

	  function SensorsData(account, script, track) {
	    var func, funcs, i, len, para, ref, ref1;
	    if (!account) {
	      return;
	    }
	    para = {
	    ...
	    window.sa = window.sa || function(a) {
	      return function() {
	        window.sa._q = window.sa._q || [];
	        return window.sa._q.push([a, arguments]);
	      };
	    };
	    funcs = ['track', 'quick', 'register', 'registerPage', 'registerOnce', 'clearAllRegister', 'trackSignup', 'trackAbtest', 'setProfile', 'setOnceProfile', 'appendProfile', 'incrementProfile', 'deleteProfile', 'unsetProfile', 'identify', 'login', 'logout', 'trackLink', 'clearAllRegister'];
	    ...
	    if (!window.sa._t) {
	      ...
	      BaseProvider.loadScript(script, 'sa', false);
	      if ((ref = window.sa) != null) {
	        ref.para = para;
	      }
	    }
	    if ((ref1 = window.sa) != null) {
	      ref1.quick('autoTrack');
	    }
	  }

	  SensorsData.prototype.setUser = function(id, raw_user) {
	    var ref, ref1;
	    if (/[a-fA-F0-9]{24}/.test(id)) {
	      if ((ref = window.sa) != null) {
	        ref.login(id);
	      }
	      return (ref1 = window.sa) != null ? ref1.setProfile(raw_user) : void 0;
	    }
	  };

	  SensorsData.prototype.event = function(gtaOptions) {
	    var data, key, normalizedAction, normalizedData, ref, value;
	    data = Common.extend({}, gtaOptions);
	    if (data.platform == null) {
	      data.platform = 'web';
	    }
	    ...
	    normalizedAction = data.action.replace(/ /g, '_').replace(/[^A-Za-z0-9_\$]/g, '').toLowerCase();
	    return (ref = window.sa) != null ? ref.track(normalizedAction, normalizedData) : void 0;
	  };

	  SensorsData.prototype.login = function(userId) {
	    var ref;
	    return (ref = window.sa) != null ? ref.login(userId) : void 0;
	  };

	  SensorsData.prototype.logout = function() {
	    var ref;
	    return (ref = window.sa) != null ? ref.logout() : void 0;
	  };

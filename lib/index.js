...
(function(root, factory) {
  ...
  'use strict';
  var $body, Providers, checkScript, extend, formatUser, getScript, gta, initGta, newGtaReg, providers, removeElement, slice, utm_daemon;
  ...
  extend = function() {
    var arg, dest, key, source, value, _i, _len;
  ...
  Providers = {
    ...
    growingio: function(account) {
      ...
      script = getScript(('https:' === document.location.protocol ? 'https://' : 'http://') + 'dn-growing.qbox.me/vds.js');
      checkScript(script);
      return {
        name: 'growingio'
      };
  ...
  utm_daemon = function() {
    ...
    try {
      ...
      if (part) {
        document.cookie = "utm=" + (encodeURI(JSON.stringify(utm))) + ";expires=" + (monthLater.toGMTString()) + ";domain=" + domain + ";path=/";
      }
    } catch (_error) {
      e = _error;
      if (gta.debug) {
  ...
  gta = {
    ...
    delegateEvents: function() {
      ...
      listener = (function(_this) {
        return function(e) {
          var el, gtaIgnore, gtaString, _ref, _ref1, _results;
          el = e.target;
          _results = [];
          while (el) {
            gtaString = (_ref = el.dataset) != null ? _ref.gta : void 0;
            gtaIgnore = (_ref1 = el.dataset) != null ? _ref1.gtaIgnore : void 0;
            if (newGtaReg.test(gtaString) && (!gtaIgnore || matches(e.target, gtaIgnore))) {
              _this.event(_this.parseGta(gtaString));
            }
            _results.push(el = el.parentElement);
          }
          return _results;
        };
      })(this);

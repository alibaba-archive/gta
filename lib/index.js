(function(root, factory) {
    ...
    setUserId: function(id) {
      ...
      try {
        for (_i = 0, _len = providers.length; _i < _len; _i++) {
          ...
          if ((_ref = provider.setUserId) != null) {
            _ref.apply(provider, id);
          }
        }
      } catch (_error) {
        e = _error;
  ...
  Providers = {
    ...
    piwik: function(account) {
      var script, url;
      if (!account) {
        return;
      }
      url = '//piwik.teambition.com';
      window._paq = [['trackPageView'], ['enableLinkTracking'], ['setTrackerUrl', "" + url + "/piwik.php"], ['setSiteId', account]];

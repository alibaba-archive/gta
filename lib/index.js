(function(root, factory) {
  ...
  'use strict';
  var $body, Providers, checkScript, getScript, gta, initGta, newGtaReg, providers, removeElement, slice;
    ...
    google: function(account) {
      ...
      return {
        ...
        event: function(gtaOptions) {
          var action, args, category, label;
          if (!window._ga) {
            return;
          }
  ...
  gta = {
    ...
    event: function(gtaOptions) {
      var e, isObject, provider, _i, _j, _len, _len1;
      try {
        ...
        if (isObject) {
          ...
          arguments[0] || (arguments[0] = ($body != null ? $body.data('page') : void 0) || ($body != null ? $body.data('category') : void 0) || 'gta');
          gtaOptions = {
            page: arguments[0],
            action: arguments[1],
            type: arguments[2]
    ...
    delegateEvents: function() {
      ...
      return $(document).off('.gta').on('click.gta', '[data-gta]', (function(_this) {
        return function(e) {
          var $target, action, category, gtaOptions, gtaString, label;

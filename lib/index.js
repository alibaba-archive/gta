  ...
  gta = {
    ...
    delegateEvents: function() {
      ...
      listener = (function(_this) {
        return function(e) {
          var gtaOptions, gtaString, _ref, _ref1;
          gtaString = e != null ? (_ref = e.target) != null ? (_ref1 = _ref.dataset) != null ? _ref1.gta : void 0 : void 0 : void 0;
          if (newGtaReg.test(gtaString)) {
            gtaOptions = _this.parseGta(gtaString);
            return _this.event(gtaOptions);
          }
        };
      })(this);

...
/***/ function(module, exports, __webpack_require__) {
	...
	GTA = (function() {
	  ...
	  GTA.prototype.version = '1.1.0-alpha.4';
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = SensorsData = (function(superClass) {
	  ...
	  SensorsData.prototype.event = function(gtaOptions) {
	    var data, normalizedAction, ref;
	    data = Common.extend({}, gtaOptions);
	    if (data.platform == null) {
	      data.platform = 'web';
	    }
	    normalizedAction = data.action.replace(/ /g, '_').replace(/[^A-Za-z0-9_\$]/g, '');
	    return (ref = window.sa) != null ? ref.track(normalizedAction, data) : void 0;
	  };

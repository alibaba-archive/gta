;(function(root, factory) {
  ...
  'use strict';
  var $body, Provider, Providers, account, checkScript, element, getScript, gta, name, provider, providers, randomProportion, removeElement, scriptUrl, slice, trackUrl;
  ...
  Providers = {
    ...
    customer: function(account) {
      var hasSet, method, setScript, _cio, _i, _len, _ref;
      if (!account) {
        return;
      }
      ...
      return {
        ...
        setUser: function(id, user) {
          var _ref1;
          setScript();
          return (_ref1 = window._cio) != null ? _ref1.identify(id, user) : void 0;
        },
        pageview: function(data) {
          var _ref1;
          setScript();
          return (_ref1 = window._cio) != null ? _ref1.page(data.page, data.title) : void 0;
        },
        event: function(category, action, label, value) {
          var data, _ref1;
          setScript();
          ...
          return (_ref1 = window._cio) != null ? _ref1.track(label, data) : void 0;
        }
      };
    },
